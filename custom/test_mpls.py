...
class RunTestMininet(tus_manager.TusApp):
    ...
    def _define_flow(self, dp):
        ...
        self.tx_read(tx_id, dp, match, actions)
        self.tx_write(tx_id, dp, match, actions)
    ...
    def packet_in_handler(self, ev):
        ...
        print()
        print(type(msg.match), msg.match)
        print(type(msg.match.fields), msg.match.fields)
        print(type(msg.match.fields[0]), msg.match.fields[0])
        print(type(msg.match.to_jsondict()), msg.match.to_jsondict())
        print('\n')
